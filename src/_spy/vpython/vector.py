...
class vec:
    def __init__(self, x=0, y=0, z=0):
        self._vec = window.glowscript.vec(x, y, z)
    ...
    def __add__(self, other):
        ...
        raise NotImplementedError("addition of vec and %s not implemented yet" % type(other))
    ...
    def __sub__(self, other):
        ...
        raise NotImplementedError("subtraction of vec and %s not is implemented yet" % type(other))
    ...
    def __mul__(self, other):
        ...
        raise NotImplementedError("multiplication of vec and %s is not implemented yet" % type(other))
    ...
    def __div__(self, other):
        ...
        raise NotImplementedError("division of vec and %s is not implemented yet" % type(other))
